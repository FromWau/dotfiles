...
abbr mirror 'sudo rate-mirrors --allow-root --entry-country AT --save /etc/pacman.d/mirrorlist arch'
abbr mirror-blackarch 'sudo rate-mirrors --allow-root --entry-country AT --save /etc/pacman.d/blackarch-mirrorlist blackarch'
