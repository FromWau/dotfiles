...
local mappings = {
	...
	m = {
		name = "maven",
		c = { "<cmd>:terminal mvn clean test package<cr>i", "maven clean test package" },
		n = { "<cmd>:terminal mvn archetype:generate<cr>i", "generate new maven project" },
		r = { "<cmd>:terminal java -jar target/test-1.jar<cr>i", "Run jar in target" },
	},
