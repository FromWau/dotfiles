...
function link_config() {
    ...
    items=(
        ags bat beets btop dunst elephant fastfetch fish git hypr
        ideavim kitty lazygit matugen mpd mpDris2 mpv
        ncmpcpp npm nvim pacman systemd wal walker wget
        mimeapps.list starship.toml tealdeer xdg-desktop-portal
    )
...
function link_local_bin() {
    ...
    items=(
        ...
        reddit-images ssh-key-fzf ssh-key-menu gpu-enable gpu-disable wallpaper-thumbs
    )
